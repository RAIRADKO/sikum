<?php
    ...
    $id = $_GET['id'];
        ...
        $show2 = mysqli_query($koneksi, "SELECT * FROM nomorpb WHERE kodepb='$id'");
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group">
                                                <label form="">Tanggal Perbup</label>
                                                    <?php if ($data2['tglpb'] == '0000-00-00') { ?>
                                                <input type="text" class="form-control" name="" value="<?php echo '';?>" readonly>
                                                    <?php } else { ?>
                                                <input type="text" class="form-control" name="" value="<?php echo date ('d-m-Y', strtotime($data2['tglpb']));?>" readonly> <?php } ?>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="" value="<?php echo $data2['namapengambilpb']?>" readonly>
                                            </div>
                                            <br>

                                            <div class="form-group">
                                                <label form="">Tanggal Ambil</label>
                                                    <?php if ($data2['tglambilpb'] == '0000-00-00') { ?>
                                                <input type="text" class="form-control" name="" value="<?php echo '';?>" readonly>
                                                    <?php } else { ?>
                                                <input type="text" class="form-control" name="" value="<?php echo date ('d-m-Y', strtotime($data2['tglambilpb']));?>" readonly> <?php } ?>
                                            </div>
                            ...
                            <a href="dataprosespbuserhukum.php" class="btn btn-danger"><i class="fa fa-reply-all"></i> Keluar</a>
