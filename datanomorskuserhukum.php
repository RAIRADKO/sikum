                            ...
                            <div class="col">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href ="aksidetailnomorskuserhukum.php?id=<?php echo $ambil_data['nosk']?>" class="btn btn-warning"><i class="fa fa-th-list"></i> Detail</a>
                                        ...
                                        <a href ="" class="btn btn-primary" onclick="alert('Maaf, SK belum turun/ di ttd')"><i class="fa fa-print"></i> Cetak</a>
                                            <?php } else {?>
                                        <a href ="kartunoskuserhukum.php?id=<?php  echo $ambil_data['nosk']?>" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a>  
                                            <?php } ?>
                                    </tr>
                                    <?php
                                        }}
