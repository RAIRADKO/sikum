                            ...
                            <div class="col">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href ="aksidetailprosesskuserhukum.php?id=<?php  echo $ambil_data['kodesk']?>" class="btn btn-warning"><i class="fa fa-th-list"></i> Detail</a> 
                                        <a href ="npskuserhukum.php?id=<?php  echo $ambil_data['kodesk']?>" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a> 
                                    </tr>
                                    <?php
                                        }}
                                    ?>
