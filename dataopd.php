            ...
            <div class="card">
                <h5 class="card-header">DATA OPD/ DINAS</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <a href="tambahopd.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                            </div>                         
                            ...
                            <div class="col">
                                <table class=" table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href ="editopd.php?id=<?php  echo $ambil_data['kodeopd']  ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                        <a href ="hapusopd.php?id=<?php echo $ambil_data['kodeopd']   ?>" class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus?')"><i class="fa fa-trash"></i> Hapus</a></td>
                                    </tr>
                                    <?php
                                        }}
                                    ?>
