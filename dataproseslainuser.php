...
<div class="container-fluid">
    <div class="row">
        <div class="col mt-2 ml-2" style="min-height: 500px;">
            <div class="card">
                <h5 class="card-header">DATA PROSES LAINNYA</h5>
                    <div class="card-body">
                        ...
                        <div class="table-responsive row mt-3">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <?php
                                        ...
                                        if (isset($_GET['cari']))
                                        {
                                            ...
                                            $query=mysqli_query($koneksi,"select * from proseslain where kodeopd LIKE '$opd%' AND(kodelain like '%$keyword%' or judul like '%$keyword%' or kodeopd like '%$keyword%') ORDER BY kodelain DESC LIMIT $start, $perpage");
                                        }
                                        else
                                        {
                                            $query=mysqli_query($koneksi,"select * from proseslain where kodeopd LIKE '$opd%' ORDER BY kodelain DESC LIMIT $start, $perpage");
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $ambil_data['kodeopd']; ?></td>
                                            <?php   if ($ambil_data['tglturun'] == '0000-00-00')
                                                    ...
                                                    else if (!empty($data['namapengambil']))
                                                    {
                                                        $_SESSION['statusproses'] = '<span class="badge badge-pill badge-success">Diambil</span>';
                                                    }
                                                    else
                                                    {
                                                        $_SESSION['statusproses'] = '<span class="badge badge-pill badge-danger">Selesai</span>';
                                                    }

                                            ?>
                                        <td><?php echo $_SESSION['statusproses'];?></td>
                                        <td><a href ="detailproseslainuser.php?id=<?php  echo $ambil_data['kodelain']?>" class="btn btn-warning"><i class="fa fa-th-list"></i> Detail</a> 
                                    </tr>
                                    <?php
                                        }}
                                    ?>
                            ...
                            <?php
                                if ((isset($_GET['cari']))=="")
                                {
                                    $data=mysqli_query($koneksi,"select * from proseslain where kodeopd LIKE '$opd%' ORDER BY kodelain DESC");
                                }
                                else 
                                {
                                    $data=mysqli_query($koneksi,"select * from proseslain where kodeopd LIKE '$opd%' AND(kodelain like '%$keyword%' or judul like '%$keyword%' or kodeopd like '%$keyword%') ORDER BY kodelain DESC");
                                }
