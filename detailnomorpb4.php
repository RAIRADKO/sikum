                        ...
                        <div class="row">
                            <div class="col">
                                <form class="form-horizontal" action="aksieditdetailnomorpb.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>No Seri</label>
                                        <input type="text" class="form-control" name="noseri" value="<?php echo $data['noseri'];?>" readonly>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label form="">Tanggal Pengundangan</label>
                                        <input type="date" class="form-control" name="ttglundang" value="<?php echo $data['tglpengundangan'];?>"> 
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="alasan" readonly><?php echo $data['alasanbonpb'];?></textarea>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label>Tanggal Ambil PB</label>
                                        <input type="date" class="form-control" name="tglambil" value="<?php echo $data['tglambilpb'];?>">     
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label form="">Nama Pengambil PB</label>
                                        <textarea class="form-control" name="pengambil"><?php echo $data['namapengambilpb'];?></textarea>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tglturunpb" value="<?php echo $data['tglturunpb'];?>" readonly> 
                                    </div>
                                    <br>
