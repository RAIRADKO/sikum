                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $ambil_data['kodeopd']; ?></td>
                                            <?php   if ($ambil_data['tglturun'] == '0000-00-00')
                                                    ...
                                                    {
                                                        $_SESSION['statusproses'] = '<span class="badge badge-pill badge-success">Selesai</span>';
                                                    }
                                            ?>
                                        <td><?php echo $_SESSION['statusproses'];?></td>
                                        <td><a href ="detailproseslainuserhukum.php?id=<?php  echo $ambil_data['kodelain']?>" class="btn btn-warning"><i class="fa fa-th-list"></i> Detail</a> 
                                    </tr>
                                    <?php
                                        }}
                                    ?>
