...
<div class="container">
    <div class="row">
        <div class="col-lg-12 mt-2" style="min-height: 500px;">
            <div class="card">
                <h5 class="card-header">Buat BON Nomor PB Baru + Nota Pengajuannya <br>(Pastikan sudah ada surat resmi permohonan BON Nomor dari OPD/Dinas)</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <form class="form-horizontal" action="simpannomorpb&np2.php" method="POST">
