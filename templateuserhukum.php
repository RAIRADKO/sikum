    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="templateuserhukum.php">Home</a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="dataassuserhukum.php">Asisten</a></li>
              <li><a class="dropdown-item" href="dataopduserhukum.php">Dinas/OPD</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="dataprosesskuserhukum.php">Proses SK</a></li>
              <li><a class="dropdown-item" href="datanomorskuserhukum.php">Penomoran SK</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="dataprosespbuserhukum.php">Proses PERBUP</a></li>
              <li><a class="dropdown-item" href="datanomorpbuserhukum.php">Penomoran PERBUP</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="dataproseslainuserhukum.php">SK Lainnya</a></li>
            </ul>
          </li>

          <li class="nav-item">
            <a class="nav-link active" href="laporanuserhukum.php">LAPORAN</a>
          </li>
