                            ...
                            <div class="col">
                                <form class="form-horizontal" action="aksieditdetailnomorsk.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tglambil" value="<?php echo $data['tglambilsk'];?>">     
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label form="">Nama Pengambil SK</label>
                                        <textarea class="form-control" name="pengambil"><?php echo $data['namapengambilsk'];?></textarea>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tglturunsk" value="<?php echo $data['tglturunsk'];?>" readonly> 
                                    </div>
                                    <br>
