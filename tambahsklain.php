<?php
    ...
    $query = mysqli_query($koneksi, "SELECT max(kodelain) as kodeTerbesar FROM proseslain");
            ...
            <div class="card">
                <h5 class="card-header">Buat Nota Pengajuan</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <form class="form-horizontal" action="simpanproseslain.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="combosedian" id="combosedian" class="form-control" onchange="tampilkan()" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="ketproses"></textarea>
                                    </div>
                                    <br>
                                    <button type="submit" class="btn btn-primary" name="btnsimpan"><i class="fa fa-save"></i> Simpan</button>
                                    <a href="dataproseslain.php" class="btn btn-danger"><i class="fa fa-reply"></i> Batal</a>
                                </form>
                            </div>
                        </div>
                    </div>
