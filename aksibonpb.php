<?php
    ...
    else
    {
        ...
        $show2 = mysqli_query($koneksi, "SELECT * FROM nomorpb INNER JOIN opd ON nomorpb.kodeopd=opd.kodeopd WHERE nopb='$id'");       
...
<div class="container">
    <div class="row">
        <div class="col-lg-12 mt-2" style="min-height: 500px;">
            <div class="card">
                <h5 class="card-header">Nota Pengajuan + BON Nomor PB</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <form class="form-horizontal" action="simpanprosespb.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="judulpb" required><?php echo $data['judulpb']?></textarea>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nopb" value="<?php echo $id?>" readonly>
                                    </div>
                                    <br>
