        ...
        <div class="col mt-2" style="min-height: 500px;">
            <div class="card"><h5 class="card-header">NOTA PENGAJUAN</h5>
                <div class="card-body">
                    ...
                    <form name="form1" method="post" action="cetaknpass.php">
                            ...
                            <div class="col">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td width="3%">:</td>
                                        <td colspan="2"><input name="tkpd" type="text" id="tkpd" class="form-control" value="<?php echo $row['namaass'] ?> Setda Kab.Purworejo."></td>
                                    </tr>
                                    <tr>
                                        <td>Dari</td>
                                        <td>:</td>
