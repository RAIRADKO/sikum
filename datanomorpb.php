            ...
            <div class="card">
                <h5 class="card-header">DATA NOMOR PB</h5>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                            <a href="tambahnomorpb.php" class="btn btn-primary" onclick="return confirm('Surat resmi permohonan BON nomornya sudah ada?')"><i class="fa fa-plus"></i> BON Baru</a>
                            </div>                         
                            ...
                            <div class="col">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href ="aksidetailnomorpbadmin.php?id=<?php echo $ambil_data['nopb']?>" class="btn btn-warning"><i class="fa fa-th-list"></i> Detail</a>
                                        ...
                                        <a href ="cetaknopb.php?id=<?php  echo $ambil_data['nopb']?>" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a>  
                                            <?php } ?>
                                            <?php if ($ambil_data['tglturunpb']=='0000-00-00') {?>
                                        <a href ="" onclick="alert('Maaf, PB belum turun/ di ttd')" class="btn btn-success"><i class="fab fa-whatsapp fa-lg"></i> Wa</a>
                                            <?php } else {?>
                                        <a href ="daftarnowapb.php?id=<?php  echo $ambil_data['kodepb']?>" class="btn btn-success"><i class="fab fa-whatsapp fa-lg"></i> Wa</a>
                                            <?php } ?>
                                    </tr>
                                    <?php
                                        }}
