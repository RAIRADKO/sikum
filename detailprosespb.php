                        ...
                        <div class="row">
                            <div class="col">
                                <form class="form-horizontal" action="aksieditdetailprosespb.php" method="POST">
                                    ...
                                    <a href="databonnopb2.php?id=<?php echo $data['kodepb']?>" class="btn btn-danger" onclick="return confirm('Sudah ada surat resmi permohonan bon?')"><i class="fa fa-credit-card"></i> BON</a>
