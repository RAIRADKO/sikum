...
{   
    ...
    else
    {
        ...
        {
            $kode = $data['kodelain'];
            $show2 = mysqli_query($koneksi, "SELECT * FROM proseslain WHERE kodelain='$kode'");
