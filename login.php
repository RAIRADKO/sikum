            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="col mt-2" action="ceklogin.php" method="post">
                            <h3 class="text-center text-info">Login</h3>
                            <div class="form-group">
                                <label for="tnip" class="text-info">NIP:</label><br>
                            ...
                            <div class="form-group">
                                <label for="tahun" class="text-info">Tahun:</label><br>
                                <input type="text" name="ttahun" id="ttahun" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <input type="submit" name="login" class="btn btn-info btn-md" value="Login">
                                <a href="daftar.php" class="btn btn-info btn-md">Daftar</a>
                            </div>
                        </form>
                    </div>
                </div>
