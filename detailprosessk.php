                            ...
                            <div class="col">
                                <form class="form-horizontal" action="aksieditdetailprosessk.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tglmasuk" value="<?php echo $data['tglmasuksk'];?>" > 
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <a href="databonnosk2.php?id=<?php echo $data['kodesk']?>" class="btn btn-danger" onclick="return confirm('Sudah ada surat resmi permohonan bon?')"><i class="fa fa-credit-card"></i> BON</a>
