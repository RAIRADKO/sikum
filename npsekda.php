        ...
        <div class="col mt-2" style="min-height: 500px;">
            <div class="card"><h5 class="card-header">NOTA DINAS</h5>
                <div class="card-body">
                    ...
                    <form name="form1" method="post" action="cetaknpsekda.php">
                            ...
                            <div class="col">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td width="3%">:</td>
                                        <td colspan="2"><input name="tkpd" type="text" id="tkpd" class="form-control" value="Sekretaris Daerah Kabupaten Purworejo"></td>
                                    </tr>
                                    <tr>
                                        <td>Melalui</td>
                                        <td>:</td>
                                        <td colspan="2"><input name="tmll" type="text" id="tmll" class="form-control" value="<?php echo $row['namaass'] ?> Setda Kab.Purworejo."></td>
                                    </tr>
                                    <tr>
                                        <td>Dari</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td><input name="tkode" type="text" id="tkode" class="form-control" value="<?php echo $data['kodelain'] ?>" readonly></td>
                                        <td></td>
                                        <td colspan="2">
